...
const About = () => {
  ...
  return (
    <>
      <div
        name="about"
        className="p-10 m-10 bg-gradient-to-b from-black to-slate-600 "
      >
        <h2 className="text-white text-center font-bold text-3xl mt-5 mb-7">
          ABOUT US
        </h2>
        <p className="text-white text-center text-1xl">
          Founded in the year 2013, by Alumni Respected Ankit Porwal and Vivek
          Samele. The Society organizes personality development programs such as
          seminars, workshops, and Language classes for the students to learn
          from their seniors.
        </p>
        <h2 className="text-white font-bold text-2xl mt-6 mb-5 ml-16">
          Faculty Heads
        </h2>
          ...
          {services.map((element) => {
            return (
              ...
              >
                ...
                <h3 className="text-sm mt-3">{element.title}</h3>
